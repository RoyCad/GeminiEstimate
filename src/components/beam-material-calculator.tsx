...
type BeamMaterialCalculatorProps = {
  onSave: (data: Inputs) => void;
  initialData?: Inputs;
  isEditing?: boolean;
};

export default function BeamMaterialCalculator({ onSave, initialData, isEditing = false }: BeamMaterialCalculatorProps) {
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-2">
                <Label htmlFor="totalBeams" className="flex items-center gap-2 text-muted-foreground text-xs"><Hash className="w-4 h-4" />Number of Beams</Label>
             ...
             <div className="space-y-2">
                <Label htmlFor="beamLength" className="flex items-center gap-2 text-muted-foreground text-xs"><ChevronsUpDown className="w-4 h-4" />Beam Length (Clear Span)</Label>
                 <div className="relative">
             ...
             <div className="space-y-2">
                <Label htmlFor="beamWidth" className="flex items-center gap-2 text-muted-foreground text-xs"><ChevronsUpDown className="w-4 h-4" />Beam Width</Label>
                 <div className="relative">
